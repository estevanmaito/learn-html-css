...
Even though we usually see pages around the internet composed with a lot of color, fonts and formats, HTML by itself is only responsible for their _structure and content_ (texts, images, videos, links, etc.), while CSS (more details on it in the second part) is responsible for the _presentation_ (instructions on how to present each content, like colors, sizes and disposition).
